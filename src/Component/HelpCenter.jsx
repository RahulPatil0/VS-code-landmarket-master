      ...
      <div className="help-content">
        ...
        <div className="help-section-container">
          <div className="help-card-container">
            <div className="help-card help-getting-started">
              <h3>Getting Started</h3>
              <ul>
                
                <li>
                  <Link to="/instructions">
                    Introduction to LandMarket, 
                    Account Setup, Navigating the Platform
                  </Link>
                </li>
                <li>
            ...
            <div className="help-card help-using-landmarket">
