...
// import './PropertyDetails.css'; // Assuming you'll add custom styles in this file
...
//         const payload = {
//             // Assuming you have the buyerId and ownerId available
...
//                     <div key={id} className="property-card shadow-lg">
...
import Footer from '../Layout/Footer'; // Import the Header component
...
const PropertyDetails = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        const payload = {
            // Replace with actual buyerId and ownerId
            buyerId: 1, 
            ownerId: 2, 
            ...contactForm,
        };
